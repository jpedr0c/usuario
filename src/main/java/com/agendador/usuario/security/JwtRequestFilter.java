package com.agendador.usuario.security;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    private final com.agendador.usuario.security.JwtUtil jwtUtil;
    private final UserDetailsService userDetailsService;

    // Construtor que inicializa as propriedades com instâncias fornecidas
    public JwtRequestFilter(com.agendador.usuario.security.JwtUtil jwtUtil, UserDetailsService userDetailsService) {
